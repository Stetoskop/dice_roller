...
/** @type {string} */
const CACHE_VERSION = '1740659543|8548938427';
/** @type {string} */
const CACHE_PREFIX = 'dice_roller-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'dice_roller.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["dice_roller.html","dice_roller.js","dice_roller.offline.html","dice_roller.icon.png","dice_roller.apple-touch-icon.png","dice_roller.worker.js","dice_roller.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["dice_roller.wasm","dice_roller.pck"];
